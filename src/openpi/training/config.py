...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        exp_name="fold_towel_gqy_03170318_s2s_a30",
    ),
    TrainConfig(
        name="fold_towel_s2m",
        model=pi0_config.Pi0Config(action_horizon=30),
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/public/datasets/pretrained-checkpoints/openpi-assets/checkpoints/pi0_base/params"),
        batch_size=128,
        exp_name="fold_towel_gqy_031703180420_s2m_a30",
    ),
    TrainConfig(
    ...
    TrainConfig(
        name="fold_towel_sm2sm_freq",
        model=pi0_config.Pi0Config(action_horizon=20),
        data=LeRobotX2robotDataConfig(
            # repo_id="fold_towel_gqy_0317_freq,fold_towel_gqy_0318_freq",
            repo_id="fold_towel_gqy_0317_freq,fold_towel_gqy_0318_freq,fold_towel_gqy_0420_freq",
            mode="sm2sm",
            state_history_size=3,
            state_future_size=2,
            # only_right_obs=True,
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/public/datasets/pretrained-checkpoints/openpi-assets/checkpoints/pi0_base/params"),
        batch_size=128,
        exp_name="fold_towel_gqy031703180420_pi0base_sm2sm_freq_h3f2_a20_dm10dh50df50po20",
    ),
    ...
    TrainConfig(
        ...
        data=LeRobotX2robotDataConfig(
            ...
            # repo_id="open_giftbox_xpc_0623,open_giftbox_xpc_0626,open_giftbox_xpc_0627,open_giftbox_xpc_0628,open_giftbox_gqy_0629,open_giftbox_sby_0630",
            # repo_id="open_giftbox_xpc_0623,open_giftbox_gqy_0629",
            # repo_id="open_giftbox_xpc_0623,open_giftbox_gqy_0629,open_giftbox_gqy_0701",
            # repo_id="open_giftbox_xpc_0623,open_giftbox_gqy_0629,open_giftbox_gqy_0701,open_giftbox_gqy_0702,open_giftbox_xpc_0703",
            repo_id="open_giftbox_xpc_0623,open_giftbox_xpc_0626,open_giftbox_xpc_0627,open_giftbox_xpc_0628,open_giftbox_gqy_0629,open_giftbox_sby_0630,open_giftbox_gqy_0701,open_giftbox_gqy_0702,open_giftbox_xpc_0703",
            mode="sm2sm",
            state_history_size=3,
            state_future_size=2,
            # only_right_obs=True,
        ...
        # exp_name="open_giftbox_xpc0623062606270628_gqy0629_sby0630_sm2sm",
        # exp_name="open_giftbox_xpc0623_gqy0629_sm2sm",
        exp_name="open_giftbox_xpc06230626062706280703_gqy062907010702_sby0630sm2sm_batch256",
    ),
    TrainConfig(
