...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(action_horizon=20),
        data=LeRobotX2robotDataConfig(
            # repo_id="fold_towel_gqy_0317,fold_towel_gqy_0318,fold_towel_gqy_0402",
            repo_id="fold_towel_gqy_0317,fold_towel_gqy_0318,fold_towel_gqy_0403",
        ...
        # exp_name="fold_towel_gqy_031703180402_03170318base_sm2sm_h3f2_a20_dm10dh50df50po20",
        # exp_name="fold_towel_gqy_031703180402_pi0base_sm2sm_h3f2_a20_dm10dh50df50po20",
        exp_name="fold_towel_gqy_031703180403_03170318base_sm2sm_h3f2_a20_dm10dh50df50po20",
    ),

    TrainConfig(
        name="fold_towel_sm2sm_higher_lr",
        model=pi0_config.Pi0Config(action_horizon=20),
        data=LeRobotX2robotDataConfig(
            # repo_id="fold_towel_gqy_0317,fold_towel_gqy_0318,fold_towel_gqy_0329",
            repo_id="fold_towel_gqy_0331",
            mode="sm2sm",
            state_history_size=3,
            state_future_size=2,
            # only_right_obs=True,
        ...
        # exp_name="checkout_chips_gqy_0312_sm2sm_h3f2_a20_dm10dh50df50po20",
        # exp_name="checkout_chips_cyn_0312_sm2sm_h3f2_a20_dm10dh50df50po20",
        exp_name="fold_towel_gqy_0331_higher_lr_sm2sm_h3f2_a20_dm10dh50df50po20",
    ),
