...
CUDA_VISIBLE_DEVICES=3 uv run examples/franka/deploy/server_policy.py --host "0.0.0.0" --port 9876 --default_prompt "pick up the object" policy:checkpoint --policy.config="pi0_franka_single_cam" --policy.dir="checkpoints/pi0_franka_single_cam/pi0_gs_franka_single_cam/29999"
